...
public class Attempts {
    static String[] accountHolders={"shreya","pooja","Manoj","sujay","Shree","Naveen","Argya"};
    static ResourceBundle resourceBundle=ResourceBundle.getBundle("application");
    static Logger logger=Logger.getLogger(Logger.GLOBAL_LOGGER_NAME);

    public static int findAccount(int start,int end,String holderName) throws AccountNotFoundException {
        if(start<=end){
