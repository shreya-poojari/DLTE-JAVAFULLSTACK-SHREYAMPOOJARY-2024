...
public class TransactionAnalysis implements Runnable {
    Transaction[] transactions = {
            new Transaction(new Date(2021, 11, 5), 900, "shreya", "friend"),
            new Transaction(new Date(2021, 07, 28), 600, "Bhavya", "family"),
            new Transaction(new Date(2021, 05, 13), 300, "Divya", "Education"),
    };
